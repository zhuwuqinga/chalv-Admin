...
export default {
  ...
  methods: {
    ...
    insuranceList() {
      ...
      request({
        url: url.v1.products.insuranceInfoList,
        method: "post",
    ...
    rowSave(form, done, loading) {
      request({
        url: url.v1.products.addInsuranceInfo,
        method: "POST",
        data: form,
      }).then((res) => {
        if (res.status !== 200) {
    ...
    rowUpdate(form, index, done, loading) {
      request({
        url: url.v1.products.updateInsuranceInfo,
        method: "POST",
        data: form,
      }).then((res) => {
        if (res.status == 404) {
    ...
    statusClick(item) {
      request({
        url: url.v1.products.infoStatus,
        method: "POST",
        data: {
          id: item.id,
